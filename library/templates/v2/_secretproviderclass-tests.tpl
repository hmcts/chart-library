{{- define "hmcts.secretproviderclass-tests.v2.2.2.tpl" -}}
...
metadata:
  name: {{ template "hmcts.releasename.v2.2.2" $root }}-tests-{{ $vault }}
spec:
  provider: azure
  parameters:
...
{{- define "hmcts.secretproviderclass-tests.v2.2.2" -}}
{{- template "hmcts.util.merge.v2.2.2" (append . "hmcts.secretproviderclass-tests.v2.2.2.tpl") -}}
{{- end -}}
