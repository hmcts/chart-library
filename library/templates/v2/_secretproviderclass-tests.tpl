{{- define "hmcts.secretproviderclass-tests.v2.2.3.tpl" -}}
...
metadata:
  name: {{ template "hmcts.releasename.v2.2.3" $root }}-tests-{{ $vault }}
spec:
  provider: azure
  parameters:
...
{{- define "hmcts.secretproviderclass-tests.v2.2.3" -}}
{{- template "hmcts.util.merge.v2.2.3" (append . "hmcts.secretproviderclass-tests.v2.2.3.tpl") -}}
{{- end -}}
