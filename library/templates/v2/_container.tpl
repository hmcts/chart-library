{{- define "hmcts.container.v2.2.2.tpl" -}}
...
{{ toYaml $languageValues.command | indent 4 }}
  ...
  env:
    ...
    {{- end -}}
      {{- ( include "hmcts.secrets.v2.2.2" .) | indent 4 }}
  ...
  {{- end }}
  volumeMounts:
  {{- ( include "hmcts.volumeMounts.v2.2.2" . ) | indent 2 }}
  {{- ( include "hmcts.secretMounts.v2.2.2" . ) | indent 2 }}
...
{{- define "hmcts.container.v2.2.2" -}}
{{- /* clear new line so indentation works correctly */ -}}
{{- println "" -}}
{{- include "hmcts.util.merge.v2.2.2" (append . "hmcts.container.v2.2.2.tpl") | indent 6 -}}
{{- end -}}