{{- define "hmcts.deploymenttests.v2.2.3.tpl" -}}
...
{{- include "hmcts.tests.header.v2.2.3" $smokedata }}
spec:
{{ $_ := set $smokedata.Values "tests" $languageValues.smoketests }}
{{- include "hmcts.tests.spec.v2.2.3" $smokedata | indent 2 }}
{{- end }}
...
{{- include "hmcts.tests.header.v2.2.3" $functionaldata }}
spec:
{{ $_ := set $functionaldata.Values "tests" $languageValues.functionaltests }}
{{- include "hmcts.tests.spec.v2.2.3" $functionaldata | indent 2 }}
{{- end }}
...
{{- include "hmcts.testscron.header.v2.2.3" $smokedatacron }}
{{ $_ := set $smokedatacron.Values "tests" $languageValues.smoketestscron }}
{{- include "hmcts.tests.spec.v2.2.3" $smokedatacron | indent 10 }}
{{- end }}
...
{{- include "hmcts.testscron.header.v2.2.3" $functionaldatacron }}
{{ $_ := set $functionaldatacron.Values "tests" $languageValues.functionaltestscron }}
{{- include "hmcts.tests.spec.v2.2.3" $functionaldatacron | indent 10 }}
{{- end }}

{{- end -}}

{{- define "hmcts.deploymenttests.v2.2.3" -}}
{{- template "hmcts.util.merge.v2.2.3" (append . "hmcts.deploymenttests.v2.2.3.tpl") -}}
{{- end -}}