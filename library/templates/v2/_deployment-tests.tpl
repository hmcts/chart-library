{{- define "hmcts.deploymenttests.v2.2.2.tpl" -}}
...
{{- include "hmcts.tests.header.v2.2.2" $smokedata }}
spec:
{{ $_ := set $smokedata.Values "tests" $languageValues.smoketests }}
{{- include "hmcts.tests.spec.v2.2.2" $smokedata | indent 2 }}
{{- end }}
...
{{- include "hmcts.tests.header.v2.2.2" $functionaldata }}
spec:
{{ $_ := set $functionaldata.Values "tests" $languageValues.functionaltests }}
{{- include "hmcts.tests.spec.v2.2.2" $functionaldata | indent 2 }}
{{- end }}
...
{{- include "hmcts.testscron.header.v2.2.2" $smokedatacron }}
{{ $_ := set $smokedatacron.Values "tests" $languageValues.smoketestscron }}
{{- include "hmcts.tests.spec.v2.2.2" $smokedatacron | indent 10 }}
{{- end }}
...
{{- include "hmcts.testscron.header.v2.2.2" $functionaldatacron }}
{{ $_ := set $functionaldatacron.Values "tests" $languageValues.functionaltestscron }}
{{- include "hmcts.tests.spec.v2.2.2" $functionaldatacron | indent 10 }}
{{- end }}

{{- end -}}

{{- define "hmcts.deploymenttests.v2.2.2" -}}
{{- template "hmcts.util.merge.v2.2.2" (append . "hmcts.deploymenttests.v2.2.2.tpl") -}}
{{- end -}}